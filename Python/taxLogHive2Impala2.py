...
hiveStatementForPythonCreate += "add FILE /home/hadoop/taxlogETL/taxLogETL2.py;"
hiveStatementForPythonCreate += "drop table tax_access_log_python_min;"
hiveStatementForPythonCreate += "CREATE TABLE tax_access_log_python_min "
...
hiveStatementForPythonCreate += " USING 'python taxLogETL2.py' "
hiveStatementForPythonCreate += " AS (client_ip,client,userid,request,method,uri,protocal,path,params,query,fileType,fileName,status,bytes_sent,date_time,referer,"
hiveStatementForPythonCreate += "useragent,agent_os,agent_browser,browserName,browserVersion,platformName,platformVersion,distName,distVersion,bot"
hiveStatementForPythonCreate += ",host ) "
hiveStatementForPythonCreate += " FROM tax_access_log_min where date_time is not NULL "
